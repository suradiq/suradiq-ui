    ...
    <div dir="rtl" className="flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-4">
          <Button 
            variant="outline" 
            className="w-full h-12 bg-white hover:bg-gray-50 font-medium"
          ...
          <Button 
            variant="outline" 
            className="w-full h-12 bg-[#1877f2] text-white hover:bg-[#1869d9] font-medium"
          ...
          <Button 
            variant="outline" 
            className="w-full h-12 bg-[#1DA1F2] text-white hover:bg-[#1a8cd8] font-medium"
          ...
          <Button 
            variant="outline" 
            className="w-full h-12 bg-[#25D366] text-white hover:bg-[#128C7E] font-medium"
